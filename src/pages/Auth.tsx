        ...
        <div className="w-full max-w-sm">
          ...
          <div className="bg-card/85 rounded-3xl p-6 border border-border/50 shadow-elevated">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full h-12 rounded-xl border-border/50 bg-background/30 hover:bg-background/50 transition-all"
              disabled={loading || oauthLoading !== null}
              onClick={async () => {
            ...
            >
              ...
              <span className="ml-2 font-medium">{t('auth.continueWithGoogle')}</span>
            </Button>
          </div>
